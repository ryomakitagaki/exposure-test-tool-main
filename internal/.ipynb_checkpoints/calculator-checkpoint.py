...
def minimize_solver(calculate_table_1: CalculateTable, calculate_table_2: CalculateTable,
    ...
    def objective_function(params: List[float]) -> float:
        ...
        lamda_gas = LamdaGas(digit_conf=0.01, solver_param=lamda_gas_param)
        e_dash = Edash(digit_conf=10000, solver_param=e_dash_param)
        k_0 = K_0(digit_conf=0.00001, solver_param=k0_param)
    ...
    lamda_gas = LamdaGas(digit_conf=0.01, solver_param=optimized_lamda_gas_param)
    e_dash = Edash(digit_conf=10000, solver_param=optimized_e_dash_param)
    k_0 = K_0(digit_conf=1e-9, solver_param=optimized_k_0_param)
